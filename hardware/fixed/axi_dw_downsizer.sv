            ...
            if ((idqueue_id == t) && idqueue_valid) begin
              ...
              if (!slv_r_valid_tran[t] || (slv_r_valid_tran[t] && slv_r_ready_tran[t])) begin
                ...
                if (mst_resp.r_valid) begin
                  ...
                  case (r_req_d.ar.burst)
                    axi_pkg::BURST_INCR: begin
                      r_req_d.ar.addr = aligned_addr(axi_pkg::largest_addr_t'(r_req_q.ar.addr),
                                                     r_req_q.ar.size) + (1 << r_req_q.ar.size);
                    end
                    axi_pkg::BURST_FIXED: begin
                  ...
                  case (r_state_q)
                    ...
                    R_INCR_DOWNSIZE, R_SPLIT_INCR_DOWNSIZE: begin
                      ...
                      if (r_req_q.burst_len == 0 || (aligned_addr(
                              axi_pkg::largest_addr_t'(r_req_d.ar.addr), r_req_q.orig_ar_size
                          ) != aligned_addr(
                              axi_pkg::largest_addr_t'(r_req_q.ar.addr), r_req_q.orig_ar_size
                          ))) begin
                        r_req_d.r_valid = 1'b1;
                      end
                    end
      ...
      W_PASSTHROUGH, W_INCR_DOWNSIZE, W_SPLIT_INCR_DOWNSIZE: begin
        ...
        if (mst_resp.w_ready && mst_req.w_valid) begin
          ...
          case (w_req_d.aw.burst)
            axi_pkg::BURST_INCR: begin
              w_req_d.aw.addr = aligned_addr(axi_pkg::largest_addr_t'(w_req_q.aw.addr),
                                             w_req_q.aw.size) + (1 << w_req_q.aw.size);
            end
            axi_pkg::BURST_FIXED: begin
          ...
          case (w_state_q)
            ...
            W_INCR_DOWNSIZE, W_SPLIT_INCR_DOWNSIZE: begin
              if (w_req_q.burst_len == 0 || (aligned_addr(
                      axi_pkg::largest_addr_t'(w_req_d.aw.addr), w_req_q.orig_aw_size
                  ) != aligned_addr(
                      axi_pkg::largest_addr_t'(w_req_q.aw.addr), w_req_q.orig_aw_size
                  ))) begin
                slv_resp_o.w_ready = 1'b1;
              end
            end
