...
(
  ...
  snoc_mp_req_t   snocn_snocl_req;
  snoc_mp_resp_t  snocn_snocl_resp;
  ...
  axi_xbar #(
    ...
    s1_axi_cvtr #(
      ...
      .dst_req_t  ( snoc_mp_req_t  ),
      .dst_resp_t ( snoc_mp_resp_t ),
      .enable_cdc ( 0              ),
      .faster_src ( 1              )
  ...
  axi_to_axi_lite #(
      ...
      .FullBW         ( 0              ),
      .FallThrough    ( 0              ),
      .full_req_t     ( snoc_mp_req_t  ),
      .full_resp_t    ( snoc_mp_resp_t ),
  ...
  axi_lite_xbar #(
    ...
    .mst_ports_req_o       ( pnoc_amo_req      ),
    .mst_ports_resp_i      ( pnoc_amo_resp     ),
